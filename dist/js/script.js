...
function tabs(tabsSelectorClass, tabsSelectorTabClass, tabClass) {
  var tabsSelector = document.querySelector(".".concat(tabsSelectorClass)),
      tabsBtns = document.querySelectorAll(".".concat(tabsSelectorTabClass)),
      tabsContent = document.querySelectorAll(".".concat(tabClass));
  tabsSelector.addEventListener('click', function (event) {
    if (event.target.classList.contains(tabsSelectorTabClass)) {
      tabsBtns.forEach(function (item) {
        item.classList.remove("".concat(tabsSelectorTabClass, "_active"));
      });
      event.target.classList.add("".concat(tabsSelectorTabClass, "_active"));
      currentID = +event.target.getAttribute('id');
      tabsContent.forEach(function (item) {
        item.classList.remove("".concat(tabClass, "_active"));

        if (+item.getAttribute('id') === currentID) {
          item.classList.add("".concat(tabClass, "_active"));
...
function renderModalFrom(item) {
  var itemTitle = item.children[0].children[1].innerHTML,
  ...
  var modalTitle = document.querySelector('.modal__descr__title'),
...
function closeModal() {
  var modal = document.querySelector('.modal_active');
  modal.classList.remove('modal_active');
  body.classList.remove('body_blocked');
} // shopping basket


var basketIcon = document.querySelector('.basket'),
...
basketWindow.addEventListener('click', function (event) {
...
function checkBasketObj(key) {
  if (getBasketObj(key)) {
    ...
    var basketObj0 = {};
    items.forEach(function (item) {
      var itemTitle = item.children[0].children[1].innerHTML.trim();
...
console.log(getBasketObj('basket')); // basket icon

function showBasketIcon(basketClass, i) {
  document.querySelector(".".concat(basketClass)).classList.add("".concat(basketClass, "_active"));
  document.querySelector(".".concat(basketClass)).classList.add("".concat(basketClass, "_animated"));
  document.querySelector(".".concat(basketClass, "__items")).textContent = i;
  setTimeout(function () {
...
function hideBasketIcon(basketClass) {
  document.querySelector(".".concat(basketClass)).classList.remove("".concat(basketClass, "_active"));
  document.querySelector(".".concat(basketClass)).classList.remove("".concat(basketClass, "_animated"));
}
...
function addOneItemToLS(item) {
  var itemTitle = item.children[0].children[1].innerHTML.trim();
  var basketObj = getBasketObj('basket');
...
function basketFromLSToBasketWindow(basketObj) {
  ...
  var itemsSumArr = document.querySelectorAll('.basket-window__item__price');
  var sum = 0;
  itemsSumArr.forEach(function (item) {
    sum += +item.innerHTML.trim().replace(/\D/g, '');
  });
  var basketWindowSumm = document.querySelector('.basket-window__summ');
  basketWindowSumm.textContent = "\u0421\u0443\u043C\u043C\u0430: ".concat(sum, " \u0440.");
}
